...
- For this repo, read `docs/assistant-capabilities.md` at the start of every new thread before doing assistant-ops or gateway changes.
- For Aliyun gateway operations, prefer `scripts/aliyun-openclaw-remote.sh` so remote execution is consistent and repeatable.
